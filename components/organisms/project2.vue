<template>
  <div class="relative bg-gradient-to-b from-black via-zinc-900 to-black text-white overflow-hidden min-h-screen">
    ...
    <!-- View Toggle -->
<div
  class="relative  z-20 hidden md:flex justify-center  mx-auto mb-12"
>
  <Button
    @click="toggleView"
      ...
      <div v-else>
        ...
        >
          ...
          <div class="max-w-md opacity-0 info-block">
            ...
            <div
              class="flex items-center justify-center gap-4 text-sm text-gray-500 uppercase tracking-wide"
            >
...
// ✅ use composable for gsap + ScrollTrigger
...
const animateSections = () => {
  // Kill all existing ScrollTriggers before new animations
