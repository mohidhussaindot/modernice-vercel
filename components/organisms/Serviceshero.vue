<template>
  ...
  >
    ...
    <div ref="pinWrapRef" class="relative z-20 w-full flex mx-auto max-w-7xl justify-center">
      <div ref="contentRef" class="relative scale-[0.5] pb-2 origin-center z-20 max-w-7xl w-full">
