<template>
  ...
  >
    ...
    <div
      ref="pinWrapRef"
      class="relative z-20 w-full flex justify-center "
    >
      <div
        ref="contentRef"
        class="relative scale-[0.8] origin-center z-20 max-w-7xl w-full px-6 pt-12 2xl:pt-[13rem] lg:pt-[8rem]"
      >
        <div class="flex flex-col lg:flex-row justify-between gap-12 lg:gap-[6rem]">
          <!-- Text Section -->
          <div class="flex-1 flex flex-col gap-[1.5rem] max-w-[32.13rem] mx-auto">
            ...
            >
              Du hast eine Vision und wir die Leidenschaft, sie zum Leben zu erwecken.
              Eine umfassende Website‑Strategie verwandelt Deine kreativen Vorstellungen in
              einen beeindruckenden digitalen Auftritt. Für ein ästhetisches Design und
              messbare Ergebnisse.
            </p>
            <div
