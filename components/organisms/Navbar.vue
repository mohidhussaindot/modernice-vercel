<template>
  ...
  <!-- Mobile Header -->
  <header class="block sm:hidden fixed top-0 left-0 z-[9999] w-full bg-[#0B061F] px-4 py-3 flex justify-between items-center">
    <!-- Logo -->
    <NuxtLink v-if="logoSrc" to="/" aria-label="Modernise home">
...
// Dropdown for desktop services menu
const openDropdown = () => {
...
// Hide/show header on scroll (desktop)
let lastScrollY = 0
const onScroll = () => {
