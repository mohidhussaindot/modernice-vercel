  ...
  >
    <div class="flex flex-col gap-6 sm:gap-8 md:gap-10 lg:gap-12 max-w-full lg:max-w-[34.188rem]">
      ...
      <p class="font-light text-[1rem] sm:text-[1.0625rem] md:text-[1.125rem]">
        ...
        Ganzen. Die nahtlose Integration von Frontend und Backend, ergänzt durch den Einsatz
        modernster Technologien wie Künstlicher Intelligenz, Großen Sprachmodellen (LLM) und Machine
        Learning, ermöglicht die Schaffung von Produkten, die den Horizont des Möglichen erweitern
        und das Nutzererlebnis auf ein ungekanntes Niveau heben.
      </p>
