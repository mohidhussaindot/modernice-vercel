<template>
    <div class="tabs-container flex gap-3 lg:gap-0 items-center flex-wrap lg:justify-between rounded-t-lg font-rajdhani font-medium">
        <BaseButton
            ...
            :class="{ 'text-opacity-100  text-white font-semibold border-b-2 border-[#85E642]': activeTab === index, 'text-opacity-50 text-[#C7C7C7]': activeTab !== index }"
